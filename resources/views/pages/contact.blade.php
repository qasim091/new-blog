...
<h1 class="text-5xl md:text-6xl font-bold mb-6">
    ...
    <span class="gradient-text">{{ $titleParts[1] ?? '' }}</span>
            ...
            <p class="text-xl text-muted-foreground">
                Have questions about UK visas, study abroad, or immigration? We're here to help Pakistanis navigate their UK journey.
            </p>
        </div>
        ...
        <div class="mt-12 grid md:grid-cols-3 gap-6">
            <div class="glass-card p-6 text-center">
                ...
                <p class="text-muted-foreground text-sm">info@uk.com.pk</p>
            </div>
            <div class="glass-card p-6 text-center">
                <svg class="w-8 h-8 mx-auto mb-3 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-muted-foreground text-sm">Lahore, Pakistan</p>
            </div>
            <div class="glass-card p-6 text-center">
                <svg class="w-8 h-8 mx-auto mb-3 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-muted-foreground text-sm">+92 300 1234567</p>
            </div>
        </div>
    </div>
</div>
