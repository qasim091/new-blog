...
<h1 class="text-5xl md:text-6xl font-bold mb-6">
    ...
    <span class="gradient-text">{{ $titleParts[1] ?? '' }}</span>
        ...
        <div class="mb-12">
            ...
            <div class="glass-card p-4 rounded-2xl flex items-center justify-center min-h-[120px] bg-gradient-to-r from-cyan-50 to-teal-50 dark:from-cyan-950 dark:to-teal-950">
