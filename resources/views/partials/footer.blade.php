    ...
    <div class="container mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('blog.category', 'technology') }}" class="text-muted-foreground hover:text-foreground transition-smooth hover:translate-x-1 inline-block font-medium">
                            Technology
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('blog.category', 'design') }}" class="text-muted-foreground hover:text-foreground transition-smooth hover:translate-x-1 inline-block font-medium">
                            Design
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('blog.category', 'business') }}" class="text-muted-foreground hover:text-foreground transition-smooth hover:translate-x-1 inline-block font-medium">
                            Business
                        </a>
                    </li>
                </ul>
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <a href="#" class="text-muted-foreground hover:text-primary transition-smooth hover:scale-110 transition-bounce">
